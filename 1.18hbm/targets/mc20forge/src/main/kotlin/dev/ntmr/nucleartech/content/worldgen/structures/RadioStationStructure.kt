...
class RadioStationStructure(
    ...
    companion object {
        val CODEC: Codec<RadioStationStructure> = RecordCodecBuilder.create { instance ->
            instance.group(
            ...
            ).apply(instance, ::RadioStationStructure)
        }
    }

    override fun type(): StructureType<*> {
        return NTechStructures.RADIO_STATION.get()
    }
}
