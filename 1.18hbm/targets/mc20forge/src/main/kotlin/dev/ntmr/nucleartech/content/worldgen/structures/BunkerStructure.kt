...
class BunkerStructure(
    ...
    companion object {
        val CODEC: Codec<BunkerStructure> = RecordCodecBuilder.create { instance ->
            instance.group(
            ...
            ).apply(instance, ::BunkerStructure)
        }
    }

    override fun type(): StructureType<*> {
        return NTechStructures.BUNKER.get()
    }
}
