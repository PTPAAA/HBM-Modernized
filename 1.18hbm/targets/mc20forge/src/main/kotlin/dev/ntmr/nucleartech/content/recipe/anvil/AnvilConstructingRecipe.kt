...
class AnvilConstructingRecipe(
    ...
    override fun assemble(container: Container, registryAccess: RegistryAccess): ItemStack = results.first().stack.copy()
    override fun getId() = recipeID
    override fun getSerializer(): Serializer = NTechRecipeSerializers.CONSTRUCTING.get()
    override fun getType() = NTechRecipeTypes.CONSTRUCTING
    ...
    override fun getResultItem(registryAccess: RegistryAccess): ItemStack = results.first().stack

    class Serializer : RecipeSerializer<AnvilConstructingRecipe> {
