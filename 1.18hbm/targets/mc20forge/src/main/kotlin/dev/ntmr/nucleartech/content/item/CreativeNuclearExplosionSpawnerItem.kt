        ...
        if (player.isShiftKeyDown) { // quick detonation
            if (!world.isClientSide) {
                if (player.canUseGameMasterBlocks()) {
                    ...
                    player.displayClientMessage(net.minecraft.network.chat.Component.translatable("chat.type.admin").append(net.minecraft.network.chat.Component.translatable("commands.nuke.failed", "not loaded")).withStyle(net.minecraft.ChatFormatting.RED), false)
