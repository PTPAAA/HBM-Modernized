...
fun Supplier<out MutableComponent>.append(component: Component): MutableComponent = get().append(component)
fun MutableComponent.append(component: Supplier<out Component>): MutableComponent = append(component.get())
