...
object NTechItems : NTechRegistry<Item> {
    ...
    private val PARTS_COMMON = Properties()
    private val PARTS_UNCOMMON = Properties().rarity(Rarity.UNCOMMON)
    private val PARTS_RARE = Properties().rarity(Rarity.RARE)
    private val PARTS_EPIC = Properties().rarity(Rarity.EPIC)
    private val ITEMS_COMMON = Properties()
    private val ITEMS_UNCOMMON = Properties().rarity(Rarity.UNCOMMON)
    private val ITEMS_RARE = Properties().rarity(Rarity.RARE)
    private val ITEMS_EPIC = Properties().rarity(Rarity.EPIC)
    ...
    val semtexBar = register("semtex_bar", defaultItem(Properties().food(FoodProperties.Builder().nutrition(4).saturationMod(0.5F).build()), tooltip = true))
    ...
    val machineUpgradeTemplate = register("machine_upgrade_template") { Item(Properties().stacksTo(1)) }
    val blankRune = register("blank_rune") { Item(Properties().stacksTo(1)) }
    val isaRune = register("isa_rune") { Item(Properties().stacksTo(1)) }
    val dagazRune = register("dagaz_rune") { Item(Properties().stacksTo(1)) }
    val hagalazRune = register("hagalaz_rune") { Item(Properties().stacksTo(1)) }
    val jeraRune = register("jera_rune") { Item(Properties().stacksTo(1)) }
    val thurisazRune = register("thurisaz_rune") { Item(Properties().stacksTo(1)) }
    val burnedOutQuadSchrabidiumFuelRod = register("burned_out_quad_schrabidium_rod", defaultItem(Properties().stacksTo(1).rarity(Rarity.EPIC), tooltip = true))
    ...
    val battery = register("battery") { BatteryItem(20_000, 400, 400, Properties()) }
    val redstonePowerCell = register("redstone_power_cell") { BatteryItem(60_000, 400, 400, Properties()) }
    val sixfoldRedstonePowerCell = register("sixfold_redstone_power_cell") { BatteryItem(360_000, 400, 400, Properties()) }
    val twentyFourFoldRedstonePowerCell = register("twenty_four_fold_redstone_power_cell") { BatteryItem(1_440_000, 400, 400, Properties()) }
    val advancedBattery = register("advanced_battery") { BatteryItem(80_000, 2_000, 2_000, Properties()) }
    val advancedPowerCell = register("advanced_power_cell") { BatteryItem(240_000, 2_000, 2_000, Properties()) }
    ...
    val schrabidiumBattery = register("schrabidium_battery") { BatteryItem(4_000_000, 20_000, 20_000, Properties().rarity(Rarity.RARE)) }
    val schrabidiumPowerCell = register("schrabidium_power_cell") { BatteryItem(12_000_000, 20_000, 20_000, Properties().rarity(Rarity.RARE)) }
    val doubleSchrabidiumPowerCell = register("double_schrabidium_power_cell") { BatteryItem(24_000_000, 20_000, 20_000, Properties().rarity(Rarity.RARE)) }
    val quadrupleSchrabidiumPowerCell = register("quadruple_schrabidium_power_cell") { BatteryItem(48_000_000, 20_000, 20_000, Properties().rarity(Rarity.RARE)) }
    val sparkBattery = register("spark_battery") { BatteryItem(400_000_000, 8_000_000, 8_000_000, Properties()) }
    val offBrandSparkBattery = register("off_brand_spark_battery") { BatteryItem(20_000_000, 160_000, 800_000, Properties()) }
    val sparkPowerCell = register("spark_power_cell") { BatteryItem(2_400_000_000L, 8_000_000, 8_000_000, Properties()) }
    val sparkArcaneCarBattery = register("spark_arcane_car_battery") { BatteryItem(10_000_000_000L, 8_000_000, 8_000_000, Properties()) }
    val sparkArcaneEnergyStorageArray = register("spark_arcane_energy_storage_array") { BatteryItem(40_000_000_000L, 8_000_000, 8_000_000, Properties()) }
    val sparkArcaneMassEnergyVoid = register("spark_arcane_mass_energy_void") { BatteryItem(400_000_000_000L, 80_000_000, 80_000_000, Properties()) }
    ...
    val stoneWireStamp = register("stone_wire_stamp") { Item(Properties().durability(10)) }
    val stoneCircuitStamp = register("stone_circuit_stamp") { Item(Properties().durability(10)) }
    val ironFlatStamp = register("iron_flat_stamp") { Item(Properties().durability(50)) }
    val ironPlateStamp = register("iron_plate_stamp") { Item(Properties().durability(50)) }
    val ironWireStamp = register("iron_wire_stamp") { Item(Properties().durability(50)) }
    val ironCircuitStamp = register("iron_circuit_stamp") { Item(Properties().durability(50)) }
    val steelFlatStamp = register("steel_flat_stamp") { Item(Properties().durability(100)) }
    val steelPlateStamp = register("steel_plate_stamp") { Item(Properties().durability(100)) }
    val steelWireStamp = register("steel_wire_stamp") { Item(Properties().durability(100)) }
    val steelCircuitStamp = register("steel_circuit_stamp") { Item(Properties().durability(100)) }
    val titaniumFlatStamp = register("titanium_flat_stamp") { Item(Properties().durability(150)) }
    val titaniumPlateStamp = register("titanium_plate_stamp") { Item(Properties().durability(150)) }
    val titaniumWireStamp = register("titanium_wire_stamp") { Item(Properties().durability(150)) }
    val titaniumCircuitStamp = register("titanium_circuit_stamp") { Item(Properties().durability(150)) }
    val obsidianFlatStamp = register("obsidian_flat_stamp") { Item(Properties().durability(170)) }
    val obsidianPlateStamp = register("obsidian_plate_stamp") { Item(Properties().durability(170)) }
    val obsidianWireStamp = register("obsidian_wire_stamp") { Item(Properties().durability(170)) }
    val obsidianCircuitStamp = register("obsidian_circuit_stamp") { Item(Properties().durability(170)) }
    val schrabidiumFlatStamp = register("schrabidium_flat_stamp") { Item(Properties().durability(3000)) }
    val schrabidiumPlateStamp = register("schrabidium_plate_stamp") { Item(Properties().durability(3000)) }
    val schrabidiumWireStamp = register("schrabidium_wire_stamp") { Item(Properties().durability(3000)) }
    val schrabidiumCircuitStamp = register("schrabidium_circuit_stamp") { Item(Properties().durability(3000)) }

    val screwdriver = register("screwdriver") { ScrewdriverItem(Properties().durability(100)) }
    val deshScrewdriver = register("desh_screwdriver") { ScrewdriverItem(Properties().stacksTo(1)) }

    val speedUpgradeMk1 = register("speed_upgrade_mk1") { MachineUpgradeItem(Properties(), SpeedUpgrade(1)) }
    val speedUpgradeMk2 = register("speed_upgrade_mk2") { MachineUpgradeItem(Properties(), SpeedUpgrade(2)) }
    val speedUpgradeMk3 = register("speed_upgrade_mk3") { MachineUpgradeItem(Properties(), SpeedUpgrade(3)) }
    val powerSavingUpgradeMk1 = register("power_saving_upgrade_mk1") { MachineUpgradeItem(Properties(), PowerSavingUpgrade(1)) }
    val powerSavingUpgradeMk2 = register("power_saving_upgrade_mk2") { MachineUpgradeItem(Properties(), PowerSavingUpgrade(2)) }
    val powerSavingUpgradeMk3 = register("power_saving_upgrade_mk3") { MachineUpgradeItem(Properties(), PowerSavingUpgrade(3)) }
    val overdriveUpgradeMk1 = register("overdrive_upgrade_mk1") { MachineUpgradeItem(Properties(), OverdriveUpgrade(1)) }
    val overdriveUpgradeMk2 = register("overdrive_upgrade_mk2") { MachineUpgradeItem(Properties(), OverdriveUpgrade(2)) }
    val overdriveUpgradeMk3 = register("overdrive_upgrade_mk3") { MachineUpgradeItem(Properties(), OverdriveUpgrade(3)) }
    val afterBurnUpgradeMk1 = register("after_burner_upgrade_mk1") { MachineUpgradeItem(Properties(), AfterBurnUpgrade(1)) }
    val afterBurnUpgradeMk2 = register("after_burner_upgrade_mk2") { MachineUpgradeItem(Properties(), AfterBurnUpgrade(2)) }
    val afterBurnUpgradeMk3 = register("after_burner_upgrade_mk3") { MachineUpgradeItem(Properties(), AfterBurnUpgrade(3)) }
    val aluminiumShredderBlade = register("aluminium_shredder_blade") { ShredderBladeItem(Properties().durability(20)) }
    val goldShredderBlade = register("gold_shredder_blade") { ShredderBladeItem(Properties().durability(30)) }
    val ironShredderBlade = register("iron_shredder_blade") { ShredderBladeItem(Properties().durability(100)) }
    val steelShredderBlade = register("steel_shredder_blade") { ShredderBladeItem(Properties().durability(200)) }
    val titaniumShredderBlade = register("titanium_shredder_blade") { ShredderBladeItem(Properties().durability(350)) }
    val advancedAlloyShredderBlade = register("advanced_alloy_shredder_blade") { ShredderBladeItem(Properties().durability(700)) }
    val combineSteelShredderBlade = register("combine_steel_shredder_blade") { ShredderBladeItem(Properties().durability(1500)) }
    val schrabidiumShredderBlade = register("schrabidium_shredder_blade") { ShredderBladeItem(Properties().durability(2000)) }
    val deshShredderBlade = register("desh_shredder_blade") { ShredderBladeItem(Properties().stacksTo(1)) }

    val rbmkLid = register("rbmk_lid") { RBMKLidItem(Properties()) }
    val rbmkGlassLid = register("rbmk_glass_lid") { RBMKLidItem(Properties()) }

    val rbmkPelletUeu = register("rbmk_pellet_ueu") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_UEU) }
    val rbmkPelletMeu = register("rbmk_pellet_meu") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_MEU) }
    val rbmkPelletHeu233 = register("rbmk_pellet_heu233") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_HEU233) }
    val rbmkPelletHeu235 = register("rbmk_pellet_heu235") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_HEU235) }
    val rbmkPelletThMeu = register("rbmk_pellet_thmeu") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_THMEU) }
    val rbmkPelletLep = register("rbmk_pellet_lep") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_LEP) }
    val rbmkPelletMep = register("rbmk_pellet_mep") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_MEP) }
    val rbmkPelletHep239 = register("rbmk_pellet_hep239") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_HEP239) }
    val rbmkPelletHep241 = register("rbmk_pellet_hep241") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_HEP241) }
    val rbmkPelletLea = register("rbmk_pellet_lea") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_LEA) }
    val rbmkPelletMea = register("rbmk_pellet_mea") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_MEA) }
    val rbmkPelletHea241 = register("rbmk_pellet_hea241") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_HEA241) }
    val rbmkPelletHea242 = register("rbmk_pellet_hea242") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_HEA242) }
    val rbmkPelletMen = register("rbmk_pellet_men") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_MEN) }
    val rbmkPelletHen = register("rbmk_pellet_hen") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_HEN) }
    val rbmkPelletMox = register("rbmk_pellet_mox") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_MOX) }
    val rbmkPelletLes = register("rbmk_pellet_les") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_LES) }
    val rbmkPelletMes = register("rbmk_pellet_mes") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_MES) }
    val rbmkPelletHes = register("rbmk_pellet_hes") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_HES) }
    val rbmkPelletLeaus = register("rbmk_pellet_leaus") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_LEAUS) }
    val rbmkPelletHeaus = register("rbmk_pellet_heaus") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_HEAUS) }
    val rbmkPelletPo210Be = register("rbmk_pellet_po210be") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_PO210BE, false) }
    val rbmkPelletRa226Be = register("rbmk_pellet_ra226be") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_RA226BE, false) }
    val rbmkPelletPu238Be = register("rbmk_pellet_pu238be") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_PU238BE) }
    val rbmkPelletBalefireGold = register("rbmk_pellet_balefire_gold") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_BALEFIRE_GOLD, false) }
    val rbmkPelletFlashlead = register("rbmk_pellet_flashlead") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_FLASHLEAD, false) }
    val rbmkPelletBalefire = register("rbmk_pellet_balefire") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_BALEFIRE, false) }
    val rbmkPelletZfbBismuth = register("rbmk_pellet_zfb_bismuth") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_ZFB_BISMUTH) }
    val rbmkPelletZfbPu241 = register("rbmk_pellet_zfb_pu241") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_ZFB_PU241) }
    val rbmkPelletZfbAmMix = register("rbmk_pellet_zfb_am_mix") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_ZFB_AM_MIX) }
    val rbmkPelletDrx = register("rbmk_pellet_drx") { RBMKPelletItem(Properties(), LangKeys.RBMK_NAME_PELLET_DRX) }

    val emptyRBMKRod = register("empty_rbmk_rod") { Item(Properties()) }
    val rbmkRodUeu = register("rbmk_rod_ueu") { RBMKRodItem(Properties(), rbmkPelletUeu, yield = 100_000_000.0, reactivity = 15.0, burnFunc = RBMKRodItem.BurnFunction.LOGARITHMIC, depletionFunc = RBMKRodItem.DepleteFunction.RAISING_SLOPE, heat = 0.65, meltingPoint = 2865.0) }
    val rbmkRodMeu = register("rbmk_rod_meu") { RBMKRodItem(Properties(), rbmkPelletMeu, yield = 100_000_000.0, reactivity = 20.0, burnFunc = RBMKRodItem.BurnFunction.LOGARITHMIC, depletionFunc = RBMKRodItem.DepleteFunction.RAISING_SLOPE, heat = 0.65, meltingPoint = 2865.0) }
    val rbmkRodHeu233 = register("rbmk_rod_heu233") { RBMKRodItem(Properties(), rbmkPelletHeu233, yield = 100_000_000.0, reactivity = 27.5, burnFunc = RBMKRodItem.BurnFunction.LINEAR, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 1.25, meltingPoint = 2865.0) }
    val rbmkRodHeu235 = register("rbmk_rod_heu235") { RBMKRodItem(Properties(), rbmkPelletHeu235, yield = 100_000_000.0, reactivity = 50.0, burnFunc = RBMKRodItem.BurnFunction.SQUARE_ROOT, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 1.0, meltingPoint = 2865.0) }
    val rbmkRodThMeu = register("rbmk_rod_thmeu") { RBMKRodItem(Properties(), rbmkPelletThMeu, yield = 100_000_000.0, reactivity = 20.0, burnFunc = RBMKRodItem.BurnFunction.PLATEAU, depletionFunc = RBMKRodItem.DepleteFunction.BOOSTED_SLOPE, heat = 0.65, meltingPoint = 3350.0) }
    val rbmkRodLep = register("rbmk_rod_lep") { RBMKRodItem(Properties(), rbmkPelletLep, yield = 100_000_000.0, reactivity = 35.0, burnFunc = RBMKRodItem.BurnFunction.LOGARITHMIC, depletionFunc = RBMKRodItem.DepleteFunction.RAISING_SLOPE, heat = 0.75, meltingPoint = 2744.0) }
    val rbmkRodMep = register("rbmk_rod_mep") { RBMKRodItem(Properties(), rbmkPelletMep, yield = 100_000_000.0, reactivity = 35.0, selfRate = 20.0, burnFunc = RBMKRodItem.BurnFunction.SQUARE_ROOT, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 1.0, meltingPoint = 2744.0) }
    val rbmkRodHep239 = register("rbmk_rod_hep239") { RBMKRodItem(Properties(), rbmkPelletHep239, yield = 100_000_000.0, reactivity = 30.0, burnFunc = RBMKRodItem.BurnFunction.LINEAR, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 1.25, meltingPoint = 2744.0) }
    val rbmkRodHep241 = register("rbmk_rod_hep241") { RBMKRodItem(Properties(), rbmkPelletHep241, yield = 100_000_000.0, reactivity = 40.0, burnFunc = RBMKRodItem.BurnFunction.LINEAR, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 1.75, meltingPoint = 2744.0) }
    val rbmkRodLea = register("rbmk_rod_lea") { RBMKRodItem(Properties(), rbmkPelletLea, yield = 100_000_000.0, reactivity = 60.0, selfRate = 10.0, burnFunc = RBMKRodItem.BurnFunction.SQUARE_ROOT, depletionFunc = RBMKRodItem.DepleteFunction.RAISING_SLOPE, heat = 1.5, meltingPoint = 2386.0) }
    val rbmkRodMea = register("rbmk_rod_mea") { RBMKRodItem(Properties(), rbmkPelletMea, yield = 100_000_000.0, reactivity = 35.0, selfRate = 20.0, burnFunc = RBMKRodItem.BurnFunction.ARCH, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 1.75, meltingPoint = 2386.0) }
    val rbmkRodHea241 = register("rbmk_rod_hea241") { RBMKRodItem(Properties(), rbmkPelletHea241, yield = 100_000_000.0, reactivity = 65.0, selfRate = 15.0, burnFunc = RBMKRodItem.BurnFunction.SQUARE_ROOT, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 1.85, meltingPoint = 2386.0, neutronType = RBMKFluxReceiver.NeutronType.FAST) }
    val rbmkRodHea242 = register("rbmk_rod_hea242") { RBMKRodItem(Properties(), rbmkPelletHea242, yield = 100_000_000.0, reactivity = 45.0, burnFunc = RBMKRodItem.BurnFunction.LINEAR, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 2.5, meltingPoint = 2386.0) }
    val rbmkRodMen = register("rbmk_rod_men") { RBMKRodItem(Properties(), rbmkPelletMen, yield = 100_000_000.0, reactivity = 30.0, burnFunc = RBMKRodItem.BurnFunction.SQUARE_ROOT, depletionFunc = RBMKRodItem.DepleteFunction.RAISING_SLOPE, heat = 0.75, meltingPoint = 2800.0, neutronType = RBMKFluxReceiver.NeutronType.ANY) }
    val rbmkRodHen = register("rbmk_rod_hen") { RBMKRodItem(Properties(), rbmkPelletHen, yield = 100_000_000.0, reactivity = 40.0, burnFunc = RBMKRodItem.BurnFunction.SQUARE_ROOT, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 1.0, meltingPoint = 2800.0, neutronType = RBMKFluxReceiver.NeutronType.FAST) }
    val rbmkRodMox = register("rbmk_rod_mox") { RBMKRodItem(Properties(), rbmkPelletMox, yield = 100_000_000.0, reactivity = 40.0, burnFunc = RBMKRodItem.BurnFunction.LOGARITHMIC, depletionFunc = RBMKRodItem.DepleteFunction.RAISING_SLOPE, heat = 1.0, meltingPoint = 2815.0) }
    val rbmkRodLes = register("rbmk_rod_les") { RBMKRodItem(Properties(), rbmkPelletLes, yield = 100_000_000.0, reactivity = 50.0, burnFunc = RBMKRodItem.BurnFunction.SQUARE_ROOT, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 1.25, meltingPoint = 2500.0, releaseType = RBMKFluxReceiver.NeutronType.SLOW) }
    val rbmkRodMes = register("rbmk_rod_mes") { RBMKRodItem(Properties(), rbmkPelletMes, yield = 100_000_000.0, reactivity = 75.0, burnFunc = RBMKRodItem.BurnFunction.ARCH, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 1.5, meltingPoint = 2750.0) }
    val rbmkRodHes = register("rbmk_rod_hes") { RBMKRodItem(Properties(), rbmkPelletHes, yield = 100_000_000.0, reactivity = 90.0, burnFunc = RBMKRodItem.BurnFunction.LINEAR, depletionFunc = RBMKRodItem.DepleteFunction.LINEAR, heat = 1.75, meltingPoint = 3000.0) }
    val rbmkRodLeaus = register("rbmk_rod_leaus") { RBMKRodItem(Properties(), rbmkPelletLeaus, yield = 100_000_000.0, reactivity = 30.0, burnFunc = RBMKRodItem.BurnFunction.SIGMOID, depletionFunc = RBMKRodItem.DepleteFunction.LINEAR, heat = 1.5, meltingPoint = 7029.0, xenonGen = 0.05) }
    val rbmkRodHeaus = register("rbmk_rod_heaus") { RBMKRodItem(Properties(), rbmkPelletHeaus, yield = 100_000_000.0, reactivity = 35.0, burnFunc = RBMKRodItem.BurnFunction.SQUARE_ROOT, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 2.0, meltingPoint = 5211.0, xenonGen = 0.05) }
    val rbmkRodPo210Be = register("rbmk_rod_po210be") { RBMKRodItem(Properties(), rbmkPelletPo210Be, yield = 25_000_000.0, reactivity = 0.0, selfRate = 50.0, burnFunc = RBMKRodItem.BurnFunction.PASSIVE, depletionFunc = RBMKRodItem.DepleteFunction.LINEAR, heat = 0.1, meltingPoint = 1287.0, xenonGen = 0.0, diffusion = 0.05, releaseType = RBMKFluxReceiver.NeutronType.SLOW) }
    val rbmkRodRa226Be = register("rbmk_rod_ra226be") { RBMKRodItem(Properties(), rbmkPelletRa226Be, yield = 100_000_000.0, reactivity = 0.0, selfRate = 20.0, burnFunc = RBMKRodItem.BurnFunction.PASSIVE, depletionFunc = RBMKRodItem.DepleteFunction.LINEAR, heat = 0.035, meltingPoint = 700.0, xenonGen = 0.0, diffusion = 0.5, releaseType = RBMKFluxReceiver.NeutronType.SLOW) }
    val rbmkRodPu238Be = register("rbmk_rod_pu238be") { RBMKRodItem(Properties(), rbmkPelletPu238Be, yield = 50_000_000.0, reactivity = 40.0, selfRate = 40.0, burnFunc = RBMKRodItem.BurnFunction.SQUARE_ROOT, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 0.1, meltingPoint = 1287.0, diffusion = 0.05, releaseType = RBMKFluxReceiver.NeutronType.SLOW) }
    val rbmkRodBalefireGold = register("rbmk_rod_balefire_gold") { RBMKRodItem(Properties(), rbmkPelletBalefireGold, yield = 100_000_000.0, reactivity = 50.0, selfRate = 10.0, burnFunc = RBMKRodItem.BurnFunction.ARCH, depletionFunc = RBMKRodItem.DepleteFunction.LINEAR, heat = 1.0, meltingPoint = 2000.0, xenonGen = 0.0) }
    val rbmkRodFlashlead = register("rbmk_rod_flashlead") { RBMKRodItem(Properties(), rbmkPelletFlashlead, yield = 25_000_000.0, reactivity = 40.0, selfRate = 50.0, burnFunc = RBMKRodItem.BurnFunction.ARCH, depletionFunc = RBMKRodItem.DepleteFunction.LINEAR, heat = 1.0, meltingPoint = 2050.0, xenonGen = 0.0) }
    val rbmkRodBalefire = register("rbmk_rod_balefire") { RBMKRodItem(Properties(), rbmkPelletBalefire, yield = 100_000_000.0, reactivity = 100.0, selfRate = 35.0, burnFunc = RBMKRodItem.BurnFunction.LINEAR, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 3.0, meltingPoint = 3652.0, xenonGen = 0.0) }
    val rbmkRodZfbBismuth = register("rbmk_rod_zfb_bismuth") { RBMKRodItem(Properties(), rbmkPelletZfbBismuth, yield = 50_000_000.0, reactivity = 20.0, burnFunc = RBMKRodItem.BurnFunction.SQUARE_ROOT, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 1.75, meltingPoint = 2744.0) }
    val rbmkRodZfbPu241 = register("rbmk_rod_zfb_pu241") { RBMKRodItem(Properties(), rbmkPelletZfbPu241, yield = 50_000_000.0, reactivity = 20.0, burnFunc = RBMKRodItem.BurnFunction.SQUARE_ROOT, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 1.0, meltingPoint = 2865.0) }
    val rbmkRodZfbAmMix = register("rbmk_rod_zfb_am_mix") { RBMKRodItem(Properties(), rbmkPelletZfbAmMix, yield = 50_000_000.0, reactivity = 20.0, burnFunc = RBMKRodItem.BurnFunction.LINEAR, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 1.75, meltingPoint = 2744.0) }
    val rbmkRodDrx = register("rbmk_rod_drx") { RBMKRodItem(Properties(), rbmkPelletDrx, yield = 1_000_000.0, reactivity = 1000.0, selfRate = 10.0, burnFunc = RBMKRodItem.BurnFunction.QUADRATIC, depletionFunc = RBMKRodItem.DepleteFunction.GENTLE_SLOPE, heat = 0.1, meltingPoint = 100_000.0) }

    val meltdownTool = register("dyatlov") { MeltdownToolItem(Properties().stacksTo(1)) }

    val graphiteDebris = register("graphite_debris") { Item(Properties()) }
    val metalDebris = register("metal_debris") { Item(Properties()) }
    val fuelDebris = register("fuel_debris") { Item(Properties()) }
    ...
    val fluidIdentifier = register("fluid_identifier") { FluidIdentifierItem(Properties()) }

    val assemblyTemplate = register("assembly_template") { AssemblyTemplateItem(Properties()) }
    val chemTemplate = register("chem_template") { ChemPlantTemplateItem(Properties()) }

    // Bomb Items

    val neutronShieldingLittleBoy = register("neutron_shielding_little_boy") { TooltipItem(Properties().stacksTo(1)) }
    val subcriticalUraniumTarget = register("subcritical_uranium235_target") { Item(Properties().stacksTo(1)) }
    val uraniumProjectile = register("uranium235_projectile") { Item(Properties().stacksTo(1)) }
    val propellantLittleBoy = register("propellant_little_boy") { TooltipItem(Properties().stacksTo(1)) }
    val bombIgniterLittleBoy = register("bomb_igniter_little_boy") { TooltipItem(Properties().stacksTo(1)) }
    val bundleOfImplosionPropellant = register("bundle_of_implosion_propellant") { TooltipItem(Properties().stacksTo(1)) }
    val bombIgniterFatMan = register("bomb_igniter_fat_man") { TooltipItem(Properties().stacksTo(1)) }
    val plutoniumCore = register("plutonium_core") { Item(Properties().stacksTo(1)) }
    val detonator = register("detonator") { DetonatorItem(Properties().stacksTo(1)) }
    val littleBoyKit = register("little_boy_kit") { BombKitItem(mapOf(NTechBlockItems.littleBoy to 1) + LittleBoyBlock.requiredComponents, 0, 0x0026FF, Properties()) }
    val fatManKit = register("fat_man_kit") { BombKitItem(mapOf(NTechBlockItems.fatMan to 1) + FatManBlock.requiredComponents, 0, 0xFFD800, Properties()) }

    // Rocketry: Missiles and Satellites

    val designator = register("designator") { DesignatorItem(Properties().stacksTo(1)) }
    val heMissile = register("he_missile") { MissileItem(::HEMissile, Properties()) }
    val incendiaryMissile = register("incendiary_missile") { MissileItem(::IncendiaryMissile, Properties()) }
    val clusterMissile = register("cluster_missile") { MissileItem(::ClusterMissile, Properties()) }
    val bunkerBusterMissile = register("bunker_buster_missile") { MissileItem(::BunkerBusterMissile, Properties()) }
    val strongMissile = register("strong_missile") { MissileItem(::StrongHEMissile, Properties(), renderModel = AbstractMissile.MODEL_MISSILE_STRONG, renderScale = 1.5F) }
    val strongIncendiaryMissile = register("strong_incendiary_missile") { MissileItem(::StrongIncendiaryMissile, Properties(), renderModel = AbstractMissile.MODEL_MISSILE_STRONG, renderScale = 1.5F) }
    val strongClusterMissile = register("strong_cluster_missile") { MissileItem(::StrongClusterMissile, Properties(), renderModel = AbstractMissile.MODEL_MISSILE_STRONG, renderScale = 1.5F) }
    val strongBunkerBusterMissile = register("strong_bunker_buster_missile") { MissileItem(::StrongBunkerBusterMissile, Properties(), renderModel = AbstractMissile.MODEL_MISSILE_STRONG, renderScale = 1.5F) }
    val burstMissile = register("burst_missile") { MissileItem(::BurstMissile, Properties(), renderModel = AbstractMissile.MODEL_MISSILE_HUGE, renderScale = 2F) }
    val infernoMissile = register("inferno_missile") { MissileItem(::InfernoMissile, Properties(), renderModel = AbstractMissile.MODEL_MISSILE_HUGE, renderScale = 2F) }
    val rainMissile = register("rain_missile") { MissileItem(::RainMissile, Properties(), renderModel = AbstractMissile.MODEL_MISSILE_HUGE, renderScale = 2F) }
    val drillMissile = register("drill_missile") { MissileItem(::DrillMissile, Properties(), renderModel = AbstractMissile.MODEL_MISSILE_HUGE, renderScale = 2F) }
    val nuclearMissile = register("nuclear_missile") { MissileItem(::NuclearMissile, Properties(), renderModel = AbstractMissile.MODEL_MISSILE_NUCLEAR, renderScale = 1.5F) }
    val tectonicMissile = register("tectonic_missile") { MissileItem(::TectonicMissile, Properties(), renderModel = AbstractMissile.MODEL_MISSILE_NUCLEAR, renderScale = 1.5F, hasTooltip = true) }

    // Consumables and Gear

    val meteorRemote = register("meteor_remote") { MeteorRemoteItem(Properties().durability(2).setNoRepair()) }
    val oilDetector = register("oil_detector") { OilDetectorItem(Properties().stacksTo(1)) }
    val pollutionDetector = register("pollution_detector") { PollutionDetectorItem(Properties().stacksTo(1)) }
    val rbmkLinker = register("rbmk_linker") { RBMKLinkerItem(Properties().stacksTo(1)) }
    val geigerCounter = register("handheld_geiger_counter") { GeigerCounterItem(Properties().stacksTo(1)) }
    val ivBag = register("iv_bag") { EmptyIVBagItem(Properties()) }
    ...
    val advancedHazmatChestplate = register("advanced_hazmat_chestplate") { FullSetBonusArmorItem(NTechArmorMaterials.advancedHazmat, ArmorItem.Type.CHESTPLATE, FullSetBonusArmorItem.FullSetBonus.EMPTY, Properties()) }
    val advancedHazmatLeggings = register("advanced_hazmat_leggings") { FullSetBonusArmorItem(NTechArmorMaterials.advancedHazmat, ArmorItem.Type.LEGGINGS, FullSetBonusArmorItem.FullSetBonus.EMPTY, Properties()) }
    val advancedHazmatBoots = register("advanced_hazmat_boots") { FullSetBonusArmorItem(NTechArmorMaterials.advancedHazmat, ArmorItem.Type.BOOTS, FullSetBonusArmorItem.FullSetBonus.EMPTY, Properties()) }
    val reinforcedHazmatHelmet = register("reinforced_hazmat_helmet") { HazmatMaskItem(NTechArmorMaterials.reinforcedHazmat, ArmorItem.Type.HELMET, FullSetBonusArmorItem.FullSetBonus(fireproof = true), Properties()) }
    val reinforcedHazmatChestplate = register("reinforced_hazmat_chestplate") { FullSetBonusArmorItem(NTechArmorMaterials.reinforcedHazmat, ArmorItem.Type.CHESTPLATE, FullSetBonusArmorItem.FullSetBonus.copyFrom(reinforcedHazmatHelmet.get()), Properties()) }
    val reinforcedHazmatLeggings = register("reinforced_hazmat_leggings") { FullSetBonusArmorItem(NTechArmorMaterials.reinforcedHazmat, ArmorItem.Type.LEGGINGS, FullSetBonusArmorItem.FullSetBonus.copyFrom(reinforcedHazmatHelmet.get()), Properties()) }
    val reinforcedHazmatBoots = register("reinforced_hazmat_boots") { FullSetBonusArmorItem(NTechArmorMaterials.reinforcedHazmat, ArmorItem.Type.BOOTS, FullSetBonusArmorItem.FullSetBonus.copyFrom(reinforcedHazmatHelmet.get()), Properties()) }
    val titaniumHelmet = register("titanium_helmet") { FullSetBonusArmorItem(NTechArmorMaterials.titanium, ArmorItem.Type.HELMET, FullSetBonusArmorItem.FullSetBonus(damageMod = .85F), Properties()) }
    val titaniumChestplate = register("titanium_chestplate") { FullSetBonusArmorItem(NTechArmorMaterials.titanium, ArmorItem.Type.CHESTPLATE, FullSetBonusArmorItem.FullSetBonus.copyFrom(titaniumHelmet.get()), Properties()) }
    val titaniumLeggings = register("titanium_leggings") { FullSetBonusArmorItem(NTechArmorMaterials.titanium, ArmorItem.Type.LEGGINGS, FullSetBonusArmorItem.FullSetBonus.copyFrom(titaniumHelmet.get()), Properties()) }
    val titaniumBoots = register("titanium_boots") { FullSetBonusArmorItem(NTechArmorMaterials.titanium, ArmorItem.Type.BOOTS, FullSetBonusArmorItem.FullSetBonus.copyFrom(titaniumHelmet.get()), Properties()) }
    val steelHelmet = register("steel_helmet") { FullSetBonusArmorItem(NTechArmorMaterials.steel, ArmorItem.Type.HELMET, FullSetBonusArmorItem.FullSetBonus(damageMod = .9F), Properties()) }
    val steelChestplate = register("steel_chestplate") { FullSetBonusArmorItem(NTechArmorMaterials.steel, ArmorItem.Type.CHESTPLATE, FullSetBonusArmorItem.FullSetBonus.copyFrom(steelHelmet.get()), Properties()) }
    val steelLeggings = register("steel_leggings") { FullSetBonusArmorItem(NTechArmorMaterials.steel, ArmorItem.Type.LEGGINGS, FullSetBonusArmorItem.FullSetBonus.copyFrom(steelHelmet.get()), Properties()) }
    val steelBoots = register("steel_boots") { FullSetBonusArmorItem(NTechArmorMaterials.steel, ArmorItem.Type.BOOTS, FullSetBonusArmorItem.FullSetBonus.copyFrom(steelHelmet.get()), Properties()) }
    val advancedAlloyHelmet = register("advanced_alloy_helmet") { FullSetBonusArmorItem(NTechArmorMaterials.advancedAlloy, ArmorItem.Type.HELMET, FullSetBonusArmorItem.FullSetBonus(damageMod = .75F), Properties()) }
    val advancedAlloyChestplate = register("advanced_alloy_chestplate") { FullSetBonusArmorItem(NTechArmorMaterials.advancedAlloy, ArmorItem.Type.CHESTPLATE, FullSetBonusArmorItem.FullSetBonus.copyFrom(advancedAlloyHelmet.get()), Properties()) }
    val advancedAlloyLeggings = register("advanced_alloy_leggings") { FullSetBonusArmorItem(NTechArmorMaterials.advancedAlloy, ArmorItem.Type.LEGGINGS, FullSetBonusArmorItem.FullSetBonus.copyFrom(advancedAlloyHelmet.get()), Properties()) }
    val advancedAlloyBoots = register("advanced_alloy_boots") { FullSetBonusArmorItem(NTechArmorMaterials.advancedAlloy, ArmorItem.Type.BOOTS, FullSetBonusArmorItem.FullSetBonus.copyFrom(advancedAlloyHelmet.get()), Properties()) }
    val combineSteelHelmet = register("combine_steel_helmet") {
        FullSetBonusArmorItem(NTechArmorMaterials.combineSteel, ArmorItem.Type.HELMET, FullSetBonusArmorItem.FullSetBonus(
    ...
    val schrabidiumChestplate = register("schrabidium_chestplate") { FullSetBonusArmorItem(NTechArmorMaterials.schrabidium, ArmorItem.Type.CHESTPLATE, FullSetBonusArmorItem.FullSetBonus.copyFrom(schrabidiumHelmet.get()), Properties()) }
    val schrabidiumLeggings = register("schrabidium_leggings") { FullSetBonusArmorItem(NTechArmorMaterials.schrabidium, ArmorItem.Type.LEGGINGS, FullSetBonusArmorItem.FullSetBonus.copyFrom(schrabidiumHelmet.get()), Properties()) }
    val schrabidiumBoots = register("schrabidium_boots") { FullSetBonusArmorItem(NTechArmorMaterials.schrabidium, ArmorItem.Type.BOOTS, FullSetBonusArmorItem.FullSetBonus.copyFrom(schrabidiumHelmet.get()), Properties()) }

    val polaroid = register("polaroid") { PolaroidItem(Properties()) }

    // Miscellaneous

    val nuclearCreeperSpawnEgg = register("nuclear_creeper_spawn_egg") { ForgeSpawnEggItem(NTechEntities.nuclearCreeper, 0x1E3E2E, 0x66B300, Properties()) }
