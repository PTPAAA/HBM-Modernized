...
class RBMKOutletBlockEntity(pos: BlockPos, state: BlockState) : BaseMachineBlockEntity(NTechBlockEntities.rbmkOutletBlockEntityType.get(), pos, state), TickingServerBlockEntity {
    //region Boilerplate
    ...
    override fun registerCapabilityHandlers() {
        registerCapabilityHandler(ForgeCapabilities.FLUID_HANDLER, this::steamTank)
    }
}
