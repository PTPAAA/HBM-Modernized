...
open class AnvilSmithingRecipe(
    ...
    override fun getSerializer(): RecipeSerializer<*> = NTechRecipeSerializers.SMITHING.get()
    override fun getType() = NTechRecipeTypes.SMITHING
    ...
    open class Serializer : RecipeSerializer<AnvilSmithingRecipe> {
