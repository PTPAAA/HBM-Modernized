...
object NTechFluids : NTechRegistry<Fluid> {
    ...
    val diesel = registerFluid("diesel", FluidAttributes.builder(ntm("fluid/diesel_still"), ntm("fluid/diesel_flow")), ::Source, ::Flowing, ::BucketItem, propertiesModifier = { tickRate(30).levelDecreasePerBlock(5) })
    ...
    val enrichedUraniumHexafluoride = registerFluid("enriched_uranium_hexafluoride", FluidAttributes.builder(ntm("fluid/uranium_hexafluoride_still"), ntm("fluid/uranium_hexafluoride_flow")).mapColor(0xFF2AC72A.toInt()).gaseous().sound(null), GaseousFluid::Source, GaseousFluid::Flowing, ::BucketItem, propertiesModifier = { tickRate(10) })
    val depletedUraniumHexafluoride = registerFluid("depleted_uranium_hexafluoride", FluidAttributes.builder(ntm("fluid/uranium_hexafluoride_still"), ntm("fluid/uranium_hexafluoride_flow")).mapColor(0xFF1D541D.toInt()).gaseous().sound(null), GaseousFluid::Source, GaseousFluid::Flowing, ::BucketItem, propertiesModifier = { tickRate(10) })
