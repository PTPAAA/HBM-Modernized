...
class GlowingMyceliumBlock(properties: Properties) : DeadGrassBlock(properties) {
    override fun stepOn(level: Level, pos: BlockPos, state: BlockState, entity: Entity) {
        ...
        val sourceName = BuiltInRegistries.BLOCK.getKey(this).toString()
        ...
        else capability.addEffectFromSource(RadiationEffect(4F, 30 * 20, false, BuiltInRegistries.BLOCK.getKey(this).toString()))
    }
