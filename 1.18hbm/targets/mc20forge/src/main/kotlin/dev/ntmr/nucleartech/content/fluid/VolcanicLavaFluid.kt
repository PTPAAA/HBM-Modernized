        ...
        if (!level.isClientSide) {
            ...
            if (!isSource(fluidState) && lavaCount < 2 || random.nextBoolean() && lavaCount < 5) {
                val resultBlock = when (random.nextInt(200)) {
                    ...
                    in 4..13 -> if (lavaCount + basaltCount == 6 && lavaCount < 3 && checkVolcanoHint(level, pos.above(10))) Blocks.BASALT.defaultBlockState() else Blocks.BASALT.defaultBlockState()
