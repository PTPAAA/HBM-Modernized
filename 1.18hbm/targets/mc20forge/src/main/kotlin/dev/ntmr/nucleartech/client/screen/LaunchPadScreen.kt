...
class LaunchPadScreen(
    ...
    override fun renderBg(graphics: GuiGraphics, partials: Float, mouseX: Int, mouseY: Int) {
        ...
        if (launchPad.energy > 0) {
            ...
            graphics.blit(texture, leftPos + 8, topPos + 53, 8, 166, energyScaled, 16)
        }
    }
    ...
    override fun renderTooltip(graphics: GuiGraphics, mouseX: Int, mouseY: Int) {
        ...
        tooltipEnergyStorage(graphics, menu.blockEntity.energyStorage, 8, 53, 160, 16, mouseX, mouseY)
    }
}
