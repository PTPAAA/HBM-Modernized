...
import dev.ntmr.nucleartech.api.explosion.SmallNukeExplosionParams
import dev.ntmr.nucleartech.system.explosion.SmallNukeExplosion
...
class NuclearCreeper(
    ...
    override fun hurt(source: DamageSource, amount: Float): Boolean {
        if (source == DamageSources.radiation(level())) { // TODO mud also heals
            heal(amount)
            return false
        }
