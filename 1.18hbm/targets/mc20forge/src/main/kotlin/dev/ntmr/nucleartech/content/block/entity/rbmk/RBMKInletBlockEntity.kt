...
class RBMKInletBlockEntity(pos: BlockPos, state: BlockState) : BaseMachineBlockEntity(NTechBlockEntities.rbmkInletBlockEntityType.get(), pos, state), TickingServerBlockEntity {
    //region Boilerplate
    ...
    override fun registerCapabilityHandlers() {
        registerCapabilityHandler(ForgeCapabilities.FLUID_HANDLER, this::waterTank)
    }
}
