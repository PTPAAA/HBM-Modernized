...
class SirenBlock(properties: Properties) : BaseEntityBlock(properties) {
    ...
    override fun use(state: BlockState, level: Level, pos: BlockPos, player: Player, handIn: InteractionHand, hit: BlockHitResult) =
        openMenu<SirenBlockEntity>(level, pos, player)
