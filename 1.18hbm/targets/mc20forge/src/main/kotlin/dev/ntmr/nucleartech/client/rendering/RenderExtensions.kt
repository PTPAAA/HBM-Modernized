...
import dev.ntmr.nucleartech.math.toVector3f
...
fun ModelBlockRenderer.renderModelAlpha(
    ...
    for (direction in Direction.values()) {
        random.setSeed(42L)
        renderQuadListAlpha(matrix, builder, red, green, blue, alpha, model.getQuads(blockState, direction, random, modelData, null), light, overlay)
    }
    random.setSeed(42L)
    renderQuadListAlpha(matrix, builder, red, green, blue, alpha, model.getQuads(blockState, null, random, modelData, null), light, overlay)
}
