...
import dev.ntmr.nucleartech.ClientRegistries
...
object NuclearRenderTypes : RenderType(
    ...
    val mushroomCloudFlash: RenderType = create("${MODID}_mushroom_cloud_flash",
    ...
    val mushroomCloudSolid: RenderType = create("${MODID}_mushroom_cloud_solid",
    ...
    val mushroomCloudTransparent: RenderType = create("${MODID}_mushroom_cloud_transparent",
        DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.QUADS, 512 * 256, true, true, CompositeState.builder()
            .setTextureState(NO_TEXTURE)
            .setShaderState(POSITION_COLOR_SHADER)
            .setCullState(NO_CULL)
    ...
    val rbmkCherenkov: RenderType = create("${MODID}_rbmk_cherenkov",
    ...
    fun mushroomCloudTextured(texture: ResourceLocation, textureOffsetY: Float): RenderType {
        val state = CompositeState.builder()
            ...
            .createCompositeState(false)
        return create("${MODID}_mushroom_cloud_textured", VertexFormats.POSITION_COLOR_TEX_NORMAL, VertexFormat.Mode.QUADS, 512 * 256, true, true, state)
    }
