...
class ThermalCentrifugeBlockEntity(pos: BlockPos, state: BlockState) : BlockEntity(NTechBlockEntities.thermalCentrifuge.get(), pos, state) {
    val energyStorage = EnergyStorageExposed(50000, 1000, 0)

    companion object {
        fun tick(level: Level, pos: BlockPos, state: BlockState, entity: ThermalCentrifugeBlockEntity) {
            // Processing logic
        }
    }
