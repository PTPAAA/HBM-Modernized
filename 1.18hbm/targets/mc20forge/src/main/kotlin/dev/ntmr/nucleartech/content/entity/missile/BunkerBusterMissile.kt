...
class BunkerBusterMissile : AbstractMissile {
    ...
    constructor(level: Level, startPos: BlockPos, targetPos: BlockPos) : super(NTechEntities.missileBunkerBuster.get(), level, startPos, targetPos)
    ...
    override fun onImpact() {
        ...
        val (x, y, z) = position()
        for (i in 1 until 15)
            level().explode(this, x, y - i, z, 5F, Level.ExplosionInteraction.BLOCK)
    }
}
