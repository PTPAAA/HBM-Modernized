...
class HugeGlowingMushroomFeature(codec: Codec<HugeMushroomFeatureConfiguration>) : net.minecraft.world.level.levelgen.feature.AbstractHugeMushroomFeature(codec) {
    ...
    override fun getTreeHeight(random: RandomSource): Int {
