...
class PumpjackBlockEntity(pos: BlockPos, state: BlockState) : AbstractOilWellBlockEntity(NTechBlockEntities.pumpjackBlockEntityType.get(), pos, state, 250_000), IODelegatedBlockEntity {
    ...
    init {
        registerCapabilityHandler(ForgeCapabilities.ENERGY, BlockPos(-1, 0, 2), this::energyStorage, Direction.WEST)
        registerCapabilityHandler(ForgeCapabilities.ENERGY, BlockPos(-1, 0, 4), this::energyStorage, Direction.WEST)
        registerCapabilityHandler(ForgeCapabilities.FLUID_HANDLER, BlockPos(1, 0, 2), this::gasTank, Direction.EAST)
        registerCapabilityHandler(ForgeCapabilities.FLUID_HANDLER, BlockPos(1, 0, 4), this::oilTank, Direction.EAST)
    }

    override val ioConfigurations = IODelegatedBlockEntity.Companion.fromTriples(blockPos, getHorizontalBlockRotation(),
        Triple(BlockPos(1, 0, 2), Direction.EAST, listOf(IOConfiguration(IOConfiguration.Mode.OUT, IODelegatedBlockEntity.Companion.DEFAULT_FLUID_ACTION))),
        Triple(BlockPos(1, 0, 4), Direction.EAST, listOf(IOConfiguration(IOConfiguration.Mode.OUT, IODelegatedBlockEntity.Companion.DEFAULT_FLUID_ACTION))),
        Triple(BlockPos(-1, 0, 2), Direction.WEST, listOf(IOConfiguration(IOConfiguration.Mode.IN, IODelegatedBlockEntity.Companion.DEFAULT_ENERGY_ACTION))),
        Triple(BlockPos(-1, 0, 4), Direction.WEST, listOf(IOConfiguration(IOConfiguration.Mode.IN, IODelegatedBlockEntity.Companion.DEFAULT_ENERGY_ACTION))),
    )
}
