...
import dev.ntmr.nucleartech.extensions.containsFluids
...
class ChemRecipe(
    ...
    override fun assemble(container: Container, registryAccess: RegistryAccess): ItemStack = resultsList.first().copy()
    override fun getId() = recipeID
    override fun getSerializer() = NTechRecipeSerializers.CHEM.get()
    override fun getType() = NTechRecipeTypes.CHEM
    ...
    override fun getResultItem(registryAccess: RegistryAccess) = resultsList.first()

    class Serializer : RecipeSerializer<ChemRecipe> {
