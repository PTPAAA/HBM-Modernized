...
object BlockTints {
    ...
    private val fluidDuctTintCache = NonThreadLocalBlockTintCache sourceFunc@{
        ...
        val clientExtensions = IClientFluidTypeExtensions.of(fluid)
        val texture = clientExtensions.stillTexture ?: return@sourceFunc -1
        try {
            ...
            FastColor.ARGB32.multiply(baseColor, clientExtensions.tintColor)
        } catch (ex: Exception) {
    ...
    fun injectTintCaches(event: LevelEvent.Load) {
