...
class PressingRecipe(
    ...
    enum class StampType(val tag: TagKey<Item>) {
        ...
        fun matches(item: Item): Boolean = ForgeRegistries.ITEMS.tags()!!.getTag(tag).contains(item)
    }
    ...
    override fun getSerializer(): Serializer = NTechRecipeSerializers.PRESSING.get()
    override fun getType() = NTechRecipeTypes.PRESSING
    ...
    class Serializer : RecipeSerializer<PressingRecipe> {
