...
import dev.ntmr.nucleartech.math.toBlockPos
...
class RBMKRadioactiveDebrisBlock(properties: Properties) : RBMKBurningDebrisBlock(properties) {
    ...
    override fun getNextTickSchedule(random: net.minecraft.util.RandomSource) = 20 + random.nextInt(20)
    ...
    private fun radiate(level: ServerLevel, pos: BlockPos) {
        ...
        for (entity in entities) {
            ...
            if (distance < 5) entity.hurt(level.damageSources().inFire(), 100F)
