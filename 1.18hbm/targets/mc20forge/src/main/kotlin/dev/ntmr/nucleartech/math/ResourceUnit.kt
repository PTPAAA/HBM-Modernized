package dev.ntmr.nucleartech.math
          ...
          T : ResourceUnit.UnitType<U, T>
{
    ...
    fun format(amount: Long, withUnitName: Boolean = true): String {
        ...
        val string = "%.${decimals}f".format(java.util.Locale.forLanguageTag(Minecraft.getInstance().languageManager.selected.replace('_', '-')), amountInUnit) + ' ' + unitPrefix
...
fun ResourceUnit.UnitType<*, *>.getPreferredUnit(amount: Int): ResourceUnit<*, *> = getPreferredUnit(amount.toLong())
