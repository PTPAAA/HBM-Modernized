...
class MissileSiloStructure(
    ...
    companion object {
        val CODEC: Codec<MissileSiloStructure> = RecordCodecBuilder.create { instance ->
            instance.group(
            ...
            ).apply(instance, ::MissileSiloStructure)
        }
    }

    override fun type(): StructureType<*> {
        return NTechStructures.MISSILE_SILO.get()
    }
}
