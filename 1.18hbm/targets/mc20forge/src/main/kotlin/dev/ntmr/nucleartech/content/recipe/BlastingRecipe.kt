...
class BlastingRecipe(
    ...
    override fun getSerializer(): Serializer = NTechRecipeSerializers.BLASTING.get()
    override fun getType() = NTechRecipeTypes.BLASTING
    ...
    class Serializer : RecipeSerializer<BlastingRecipe> {
