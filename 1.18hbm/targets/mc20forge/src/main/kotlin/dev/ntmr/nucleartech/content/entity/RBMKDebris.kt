...
import dev.ntmr.nucleartech.system.capability.contamination.addEffectFromSource
import dev.ntmr.nucleartech.system.capability.contamination.effect.RadiationEffect
import dev.ntmr.nucleartech.system.capability.contamination.hasEffectFromSource
import dev.ntmr.nucleartech.system.capability.contamination.modifyEffectFromSourceIf
...
class RBMKDebris : Entity {
    ...
    constructor(level: Level, pos: Vec3, debrisType: DebrisType) : super(NTechEntities.rbmkDebris.get(), level) {
        moveTo(pos)
