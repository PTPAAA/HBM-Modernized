...
class CyberCrabEntity(type: EntityType<out CyberCrabEntity>, level: Level) : Monster(type, level) {

    override fun registerGoals() {
        this.goalSelector.addGoal(1, FloatGoal(this))
        this.goalSelector.addGoal(2, LeapAtTargetGoal(this, 0.6F)) // Higher jump
        this.goalSelector.addGoal(3, MeleeAttackGoal(this, 1.2, true))
