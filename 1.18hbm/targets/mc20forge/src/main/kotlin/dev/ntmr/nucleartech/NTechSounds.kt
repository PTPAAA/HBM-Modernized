...
object NTechSounds : NTechRegistry<SoundEvent> {
    override val forgeRegistry: DeferredRegister<SoundEvent> = DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, MODID)
    ...
    private fun register(name: String): RegistryObject<SoundEvent> = register(name) { SoundEvent.createVariableRangeEvent(ntm(name)) }
}
