package dev.ntmr.nucleartech.api.sound
...
public class MachineSoundInstance(sound: SoundEvent, source: SoundSource, pos: BlockPos, loop: Boolean, volume: Float = 1F, pitch: Float = 1F) : AbstractTickableSoundInstance(sound, source, net.minecraft.util.RandomSource.create()) {
    init {
        x = pos.x + .5
        y = pos.y + .5
        z = pos.z + .5
