...
class AssemblyRecipeBuilder(private val result: Item, private val count: Int, private val duration: Int) : RecipeBuilder {
    ...
    override fun save(consumer: Consumer<FinishedRecipe>, recipeName: ResourceLocation) {
        ...
        consumer.accept(Result(recipeName, ingredients, result, count, duration, advancement, ResourceLocation(recipeName.namespace, "recipes/assembly/${recipeName.path}")))
    }
    ...
    private class Result(
        ...
        override fun getType() = NTechRecipeSerializers.ASSEMBLY.get()
