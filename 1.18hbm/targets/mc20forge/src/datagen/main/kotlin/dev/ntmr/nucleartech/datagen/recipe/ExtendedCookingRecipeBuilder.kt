...
class ExtendedCookingRecipeBuilder(
    ...
    private val serializer: RecipeSerializer<out AbstractCookingRecipe> = RecipeSerializer.SMELTING_RECIPE
) : RecipeBuilder {
    constructor(
        ...
        result: ItemLike,
        resultCount: Int = 1,
        serializer: RecipeSerializer<out AbstractCookingRecipe> = RecipeSerializer.SMELTING_RECIPE
    ...
    override fun save(consumer: Consumer<FinishedRecipe>, recipeName: ResourceLocation) {
        ...
        consumer.accept(
            Result(
                ...
                ResourceLocation(recipeName.namespace, "recipes/cooking/${recipeName.path}"),
                serializer
            )
        )
    }
