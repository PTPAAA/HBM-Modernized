...
class BlastingRecipeBuilder(private val result: Item, val experience: Float, val count: Int = 1) : RecipeBuilder {
    ...
    override fun save(consumer: Consumer<FinishedRecipe>, recipeName: ResourceLocation) {
        ...
        consumer.accept(Result(recipeName, result, count, experience, ingredient1, ingredient2, advancement, ResourceLocation(recipeName.namespace, "recipes/blasting/${recipeName.path}")))
    }
    ...
    class Result(
        ...
        override fun getType() = NTechRecipeSerializers.BLASTING.get()
