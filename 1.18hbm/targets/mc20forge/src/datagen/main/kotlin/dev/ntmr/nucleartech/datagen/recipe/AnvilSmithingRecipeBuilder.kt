...
class AnvilSmithingRecipeBuilder(private val tier: Int, private val result: ItemStack) : RecipeBuilder {
    ...
    override fun save(consumer: Consumer<FinishedRecipe>, recipeName: ResourceLocation) {
        ...
        consumer.accept(Result(recipeName, tier, result, left, right, advancement, ResourceLocation(recipeName.namespace, "recipes/anvil_smithing/${recipeName.path}")))
    }
    ...
    private class Result(
        ...
        override fun getType() = NTechRecipeSerializers.SMITHING.get()
