...
class PressRecipeBuilder(private val result: Item, val stampType: PressingRecipe.StampType, val experience: Float, val count: Int = 1) : RecipeBuilder {
    ...
    override fun save(consumer: Consumer<FinishedRecipe>, recipeName: ResourceLocation) {
        ...
        consumer.accept(Result(recipeName, result, count, experience, stampType, ingredient, advancement, ResourceLocation(recipeName.namespace, "recipes/pressing/${recipeName.path}")))
    }
    ...
    class Result(
        ...
        override fun getType() = NTechRecipeSerializers.PRESSING.get()
