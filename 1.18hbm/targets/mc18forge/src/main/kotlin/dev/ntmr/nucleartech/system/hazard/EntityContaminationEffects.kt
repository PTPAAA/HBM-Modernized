...
object EntityContaminationEffects {
    ...
    private fun handleRadiation(entity: LivingEntity, capability: ContaminationHandler) {
        ...
        when {
            entity is Creeper && irradiation >= 200 && !entity.isDeadOrDying -> if (world.random.nextInt(3) == 0) entity.convertTo(NTechEntities.nuclearCreeper.get(), true) else entity.hurt(DamageSources.radiation, 100F)
