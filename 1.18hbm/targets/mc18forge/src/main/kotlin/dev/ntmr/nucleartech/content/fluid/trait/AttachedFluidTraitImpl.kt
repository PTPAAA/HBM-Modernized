...
class AttachedFluidTraitImpl<out T : FluidTrait> private constructor(
    ...
    companion object {
        ...
        fun deserializeFromNetwork(buffer: FriendlyByteBuf) = AttachedFluidTraitImpl(
            buffer.readRegistryIdSafe(FluidTrait::class.java),
    ...
    private data class IdTarget(private val fluid: Fluid) : AttachedFluidTrait.FluidTarget {
        ...
        override fun toString() = fluid.registryName!!.toString()
    }
