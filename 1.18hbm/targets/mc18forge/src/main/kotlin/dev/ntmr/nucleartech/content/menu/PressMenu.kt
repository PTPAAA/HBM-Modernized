...
class PressMenu(
...
) : NTechContainerMenu<SteamPressBlockEntity>(NTechMenus.steamPressMenu.get(), windowId, playerInventory, blockEntity) {
    ...
    private fun canPress(itemStack: ItemStack) =
        level.recipeManager.getRecipeFor(NTechRecipeTypes.PRESSING, SimpleContainer(itemStack), level).isPresent
