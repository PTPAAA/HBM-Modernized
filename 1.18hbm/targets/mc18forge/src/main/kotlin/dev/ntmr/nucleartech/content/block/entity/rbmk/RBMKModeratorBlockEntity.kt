...
class RBMKModeratorBlockEntity(pos: BlockPos, state: BlockState) : NoInventoryRBMKBaseBlockEntity(NTechBlockEntities.rbmkModeratorBlockEntityType.get(), pos, state) {
