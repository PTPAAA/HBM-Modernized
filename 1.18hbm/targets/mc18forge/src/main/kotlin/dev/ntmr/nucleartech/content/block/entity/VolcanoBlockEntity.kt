...
import dev.ntmr.nucleartech.content.entity.VolcanicShrapnel
...
class VolcanoBlockEntity(pos: BlockPos, state: BlockState) : BlockEntity(NTechBlockEntities.volcanoBlockEntityType.get(), pos, state), TickingServerBlockEntity {
    ...
    private fun emitSmoke(level: Level, pos: BlockPos) {
        ...
        level.sendParticles(NTechParticles.VOLCANO_SMOKE.get(), true, x, y, z, 1, 0.0, 0.0, 0.0, 0.0)
    }
