...
import dev.ntmr.nucleartech.content.block.entity.BlockEntityWrapper
import dev.ntmr.nucleartech.content.block.rbmk.RBMKBaseBlock
import dev.ntmr.nucleartech.content.entity.RBMKDebris
import dev.ntmr.nucleartech.content.particle.RBMKMushParticleOptions
...
interface RBMKBase : BlockEntityWrapper, TickingServerBlockEntity {
    ...
    fun meltdown() {
        ...
        level.playSound(null, centerX + 0.5, blockPosWrapped.y + 1.0, centerZ + 0.5, NTechSounds.rbmkExplosion.get(), SoundSource.BLOCKS, 50F, 1F)
    }
