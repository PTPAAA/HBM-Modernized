...
import dev.ntmr.nucleartech.api.menu.slot.ResultSlot
...
) : NTechContainerMenu<CentrifugeBlockEntity>(NTechMenus.centrifugeMenu.get(), windowID, playerInventory, blockEntity) {
