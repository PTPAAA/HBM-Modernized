...
class RBMKAbsorberBlockEntity(pos: BlockPos, state: BlockState) : NoInventoryRBMKBaseBlockEntity(NTechBlockEntities.rbmkAbsorberBlockEntityType.get(), pos, state) {
