...
package dev.ntmr.nucleartech.core.energy

import dev.ntmr.nucleartech.core.math.ResourceUnit

private const val HE_TO_FE_RATIO = 4.0

@Suppress("EnumEntryName")
enum class EnergyUnit(override val ratio: Double, override val leniency: Int, override val decimals: Int, override val unitPrefix: String, override val unitType: UnitType) :
    ResourceUnit<EnergyUnit, EnergyUnit.UnitType> {
