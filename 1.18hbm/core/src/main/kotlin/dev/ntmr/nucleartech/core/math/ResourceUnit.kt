...
package dev.ntmr.nucleartech.core.math
          ...
          T : ResourceUnit.UnitType<U, T>
{
    ...
    fun format(amount: Long, withUnitName: Boolean = true): String {
        ...
        val string = "%.${decimals}f".format(/*Minecraft.getInstance().languageManager.selected.javaLocale, */amountInUnit) + ' ' + unitPrefix // TODO localization
...
fun ResourceUnit.UnitType<*, *>.formatPreferred(amount: Long, withUnitName: Boolean = true) = getPreferredUnit(amount).format(amount, withUnitName)
fun ResourceUnit.UnitType<*, *>.formatPreferred(amount: Int, withUnitName: Boolean = true) = getPreferredUnit(amount).format(amount, withUnitName)
