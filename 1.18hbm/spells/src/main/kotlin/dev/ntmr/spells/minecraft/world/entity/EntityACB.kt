...
@Linkage(MC18, "net.minecraft.world.entity.Entity")
@MirrorBlueprint
@MirrorBlueprint.Abstract
@MirrorBlueprint.Constructor(MC18, "L%%GENERATED%%net/minecraft/world/entity/EntityType<*>;L%%GENERATED%%net/minecraft/world/level/Level;")
sealed interface EntityACB {
}
